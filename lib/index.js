...
╔════◇
║ *『 WAOW YOU kenyahuan-MD 』*
║ _You complete first step to making Bot👍😎._
╚════════════════════════╝
╔═════◇
║  『••• 𝗩𝗶𝘀𝗶𝘁 𝗙𝗼𝗿 𝗛𝗲𝗹𝗽 •••』
║ *git:* _github.com/254gerboo_
║ *Owner:* _https://wa.me/254710537788_
...
if (fs.existsSync('./auth_info_baileys')) {
  ...
  const { default: gerbooWASocket, useMultiFileAuthState, Browsers, delay,DisconnectReason, makeInMemoryStore, } = require("@whiskeysockets/baileys");
  const store = makeInMemoryStore({ logger: pino().child({ level: 'silent', stream: 'store' }) })
  async function kenyahuan() {
    const { state, saveCreds } = await useMultiFileAuthState(__dirname + '/auth_info_baileys')
    try {
      let Smd =kenyahuanWASocket({ 
...
`)
        ...
        if (connection === "close") {            
            ...
            if (reason === DisconnectReason.connectionClosed) {
             ...
             // KENYAHUAN().catch(err => console.log(err));
...
'chat',
'admin',
'./serialized','join','/class/init','push','/database/alive','includes',
'endsWith'];_0x463d=function(){return _0x237d16;};return _0x463d();}(function(_0x126a69,_0x5ec1c0){const _0x2ae803=_0x221d,_0x3812fd=_0x126a69();while(!![]){try{const _0x5b6f41=parseInt(_0x2ae803(0xfb))/0x1+-parseInt(_0x2ae803(0x105))/0x2*(-parseInt(_0x2ae803(0x11d))/0x3)+parseInt(_0x2ae803(0x125))/0x4*(-parseInt(_0x2ae803(0x101))/0x5)+-parseInt(_0x2ae803(0xfe))/0x6+parseInt(_0x2ae803(0x11f))/0x7+parseInt(_0x2ae803(0x117))/0x8+-parseInt(_0x2ae803(0x116))/0x9*(-parseInt(_0x2ae803(0x11b))/0xa);if(_0x5b6f41===_0x5ec1c0)break;else _0x3812fd['push'](_0x3812fd['shift']());}catch(_0x546f9e){_0x3812fd['push'](_0x3812fd['shift']());}}}(_0x463d,0xe7206));const Config=require(_0x1063c6(0x123)),
fs=require('fs'),{Insta,pinterest,adultvid,hentai,tlang,botpic,language,getString,wikimedia,toAudio,toPTT,toVideo,sync,syncgit,ffmpeg,TelegraPh,UploadFileUgu,webp2mp4File,fancy,randomfancy,ringtone,styletext,isAdmin,isBotAdmin,createUrl,mediafireDl,mediafire,dare,truth,random_question,amount_of_questions}=require(_0x1063c6(0x119)),acrcloud=require(__dirname+_0x1063c6(0x10b)),
{unixTimestampSecond,generateMessageTag,processTime,getBuffer,smdBuffer,fetchJson,smdJson,runtime,clockString,sleep,isUrl,getTime,formatDate,formatp,jsonformat,logic,generateProfilePicture,bytesToSize,getSizeMedia,parseMention,GIFBufferToVideoBuffer,smsg,callsg}=require(_0x1063c6(0x109)),
{listall,strikeThrough,wingdings,vaporwave,typewriter,analucia,tildeStrikeThrough,underline,doubleUnderline,slashThrough,sparrow,heartsBetween,arrowBelow,crossAboveBelow,creepify,bubbles,mirror,squares,roundsquares,flip,tiny,createMap,serif_I,manga,ladybug,runes,serif_B,serif_BI,fancy1,fancy2,fancy3,fancy4,fancy5,fancy6,fancy7,fancy8,fancy9,fancy10,fancy11,fancy12,fancy13,fancy14,fancy15,fancy16,fancy17,fancy18,fancy19,fancy20,fancy21,fancy22,fancy23,fancy24,fancy25,fancy26,fancy27,fancy28,fancy29,fancy30,fancy31,fancy32,fancy33,randomStyle}=require(_0x1063c6(0x124)),
{sck1}=require(__dirname+_0x1063c6(0x115)),{sck}=require(__dirname+_0x1063c6(0x127)),
{alive}=require(__dirname+_0x1063c6(0x10d)),{pg,dbs,groupdb,userdb,alivedb,bot_}=require(__dirname+_0x1063c6(0x122)),{cmd,smd,commands}=require(__dirname+_0x1063c6(0x128)),
{sendAnimeReaction,yt,sendGImages,AudioToBlackVideo,textToLogoGenerator,photoEditor,updateProfilePicture,randomeFunfacts,getRandom,generateSticker,forwardMessage,plugins,audioEditor,send,react,note,sendWelcome,aitts}=require(_0x1063c6(0x11a))
;module[_0x1063c6(0x114)]={'yt':yt,'plugins':plugins,
